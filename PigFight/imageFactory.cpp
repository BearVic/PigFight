...
ImageFactory::~ImageFactory() {
  ...
  //   delete fi.second;
  // }
  std::map<string, SDL_Surface*>::const_iterator si = surfaces.begin();
  std::map<string, SDL_Texture*>::const_iterator ti = textures.begin();
  std::map<string, Image*>::const_iterator fi = images.begin();
